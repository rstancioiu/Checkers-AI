...
public class Menu extends JFrame{
    ...
    private void createAndShowGUI() {
        ...
        left[5] = new JButton("IA Heuristique");
        right[5] = new JButton("IA Heuristique");
        ...
        info.setBounds(150,30,400,144);
        panel.add(info);

        start.setBounds(300,560,100,50);
        start.addActionListener(new ListenerStart());
        left[0].setBounds(20,200,120,40);
        left[1].setBounds(20,270,120,40);
        left[2].setBounds(20,340,120,40);
        left[3].setBounds(20,410,120,40);
        left[4].setBounds(20,480,120,40);
        left[5].setBounds(20,550,120,40);
        ...
        left[5].addActionListener(new ListenerLeft());
        right[0].setBounds(550,200,120,40);
        right[1].setBounds(550,270,120,40);
        right[2].setBounds(550,340,120,40);
        right[3].setBounds(550,410,120,40);
        right[4].setBounds(550,480,120,40);
        right[5].setBounds(550,550,120,40);
